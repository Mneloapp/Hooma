...
export function Hero() {
  return (
    <section className="relative min-h-[calc(100svh-4rem)] overflow-hidden bg-hooma-text text-white">
      <Image src="/catalog-images/hooma-cotton.jpg" alt="HOOMA compressed sofa in a warm living room" fill priority className="hero-kenburns object-cover opacity-75" sizes="100vw" />
      ...
      <div className="relative mx-auto flex min-h-[calc(100svh-4rem)] max-w-7xl items-center px-4 pb-20 pt-16 sm:px-6 lg:px-8">
        <div className="max-w-2xl">
          ...
          <p className="mb-5 animate-[fade-slide-up_760ms_ease-out_80ms_both] text-sm font-medium uppercase tracking-[0.28em] text-white/75">Premium compressed furniture</p>
          <h1 className="animate-[fade-slide-up_820ms_ease-out_160ms_both] text-5xl font-semibold leading-none md:text-7xl">Furniture, Reimagined.</h1>
          <p className="mt-6 max-w-lg animate-[fade-slide-up_880ms_ease-out_240ms_both] text-lg leading-8 text-white/78">Premium compressed furniture for modern living.</p>
