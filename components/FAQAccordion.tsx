...
const faqs = [
  ["როდის იქნება შეკვეთა მზად?", "Hooma-ს საწყისი სამიზნეა შეკვეთის წარმოება და მიწოდებისთვის მომზადება 3 სამუშაო დღეში. ინდივიდუალური ან რთული პროდუქტის შემთხვევაში ზუსტ დროს შეკვეთის დადასტურებისას გაცნობებთ."],
