                  ...
                  {columnCards.map((card) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <p className="mt-1 text-[11px] text-hooma-muted">პროდუქტები {money.format(card.subtotal)} · მიწოდება {card.deliveryFee === 0 ? "უფასო" : money.format(card.deliveryFee)} · {card.deliveryBenefitCode === "hooma_plus" ? "Hooma+" : card.deliveryBenefitCode === "subtotal_threshold" ? "100₾-ზე მეტი" : card.deliveryBenefitCode === "welcome_units" ? "პირველი 10 ერთეული" : card.deliveryBenefitCode === "standard_fee" ? "სტანდარტული" : "Legacy"}</p>
