      ...
      {variants.map((variant) => (
        <div key={variant.id} className="rounded-[1.25rem] border border-hooma-text/10 bg-white/65 p-4">
          <div className="grid gap-4 md:grid-cols-3">
            ...
            <label className="block text-sm font-medium">Variant<input defaultValue={variant.sizeLabel} className="mt-2 w-full rounded-full border border-hooma-text/10 px-4 py-3" /></label>
