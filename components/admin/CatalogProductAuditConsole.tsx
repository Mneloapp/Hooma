...
function BulkApproval({ jobs }: { jobs: AuditJob[] }) {
  ...
  return (
    <form action={action} className="rounded-2xl border border-amber-200 bg-amber-50 p-5">
      <div className="flex items-start gap-3"><TriangleAlert size={20} className="mt-0.5 shrink-0 text-amber-800" /><div><h3 className="font-semibold text-amber-950">მაღალი სანდოობის ჯგუფური დამტკიცება</h3><p className="mt-1 text-sm leading-6 text-amber-900">ერთ მოქმედებაზე დამტკიცდება მაქსიმუმ 100 შედეგი, მხოლოდ 85%+ სანდოობით და გაფრთხილების გარეშე. ფოტოები კატალოგიდან ამოიღება, თუმცა Storage-ში რჩება Audit rollback-ისთვის.</p></div></div>
