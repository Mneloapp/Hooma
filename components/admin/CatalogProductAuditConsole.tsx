...
export function CatalogProductAuditConsole({
  ...
  return (
    <section className="space-y-6 border-t border-hooma-text/10 pt-8">
      <div><div className="flex items-center gap-2 text-hooma-accent"><Sparkles size={19} /><p className="text-xs font-semibold uppercase tracking-[0.22em]">Catalog quality auditor</p></div><h2 className="mt-3 text-3xl font-semibold">პროდუქტების სახელი, ზომა, აღწერა და ფოტოები</h2><p className="mt-3 max-w-4xl text-sm leading-6 text-hooma-muted">Vision Agent keyset-რიგით გაივლის მხოლოდ აუდიტ-გაუვლელ პროდუქტებს — მთელი კატალოგი მეხსიერებაში არ იტვირთება. წარმატებული AI შედეგი მაშინვე ინიშნება დასრულებულად და ხელახლა აღარ იგზავნება; პროდუქტი მხოლოდ შენი დამტკიცების შემდეგ შეიცვლება.</p></div>
      ...
      <form action={createJob} className="rounded-[1.75rem] bg-white/75 p-6 shadow-soft">
        <div className="flex items-start gap-3"><span className="rounded-2xl bg-hooma-accent/10 p-3 text-hooma-accent"><Bot size={22} /></span><div><h3 className="text-xl font-semibold">აუდიტ-გაუვლელი პროდუქტების გაშვება</h3><p className="mt-1 text-sm leading-6 text-hooma-muted">ფოტოებსა და არსებულ მონაცემებზე დაყრდნობით შეიქმნება ბუნებრივი ქართული/ინგლისური სახელი, მიახლოებითი ზომა, მოკლე აღწერა და ფოტოების relevance სია. უკვე მიღებული შედეგი აღარ დამუშავდება მეორედ.</p></div></div>
