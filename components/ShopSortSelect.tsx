...
export function ShopSortSelect({ defaultValue }: { defaultValue: string }) {
  ...
  const options = language === "ka"
    ? [["newest", "ახლად გამოქვეყნებული"], ["featured", "რეკომენდებული"], ["rating", "უმაღლესი შეფასება"], ["sales", "ყველაზე გაყიდვადი"], ["name", "სახელის მიხედვით"], ["fastest", "მომზადების დრო"]]
    : [["newest", "Newest"], ["featured", "Recommended"], ["rating", "Top rated"], ["sales", "Best selling"], ["name", "By name"], ["fastest", "Lead time"]];
