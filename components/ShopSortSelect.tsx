...
export function ShopSortSelect({ defaultValue }: { defaultValue: string }) {
  ...
  const options = language === "ka"
    ? [["featured", "რეკომენდებული"], ["rating", "უმაღლესი შეფასება"], ["sales", "ყველაზე გაყიდვადი"], ["name", "სახელის მიხედვით"], ["fastest", "მომზადების დრო"]]
    : [["featured", "Recommended"], ["rating", "Top rated"], ["sales", "Best selling"], ["name", "By name"], ["fastest", "Lead time"]];
