...
const workflowErrors: Array<[string, string]> = [
  ...
  ["PRINT_JOB_ORDER_ITEM_IMMUTABLE", "საბეჭდი სამუშაოს შეკვეთის პროდუქტი შეცვლას არ ექვემდებარება."],
  ["ORDER_STATE_CONFLICT", "შეკვეთის სტატუსი უკვე შეიცვალა და ეს მოქმედება აღარ არის ხელმისაწვდომი."],
  ["ORDER_REFUND_HOLD_ACTIVE", "ამ შეკვეთაზე თანხის დაბრუნების ოპერაციული HOLD მოქმედებს. წარმოების ჩვეულებრივი მოქმედებები დაბლოკილია — დაუკავშირდი Owner/Admin-ს."],
