...
const steps = [
  ...
  ["03", "ვამზადებთ", "დადასტურებული შეკვეთა ნაწილდება პრინტერის რიგში. V1-ში გაშვებას ყოველთვის ოპერატორი ადასტურებს.", Printer],
