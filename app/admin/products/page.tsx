...
type ProductListItem = { id: string; name: string; slug: string; category: string; categorySlug: string; subcategory: string; printMinutes: number | null; grams: number | null; price: number | null; production: string; status: string };
