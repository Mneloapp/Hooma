...
/**
 * Finishes a browser-native provider sign-in after Supabase has stored the
 * session cookies. Keeping the authorization check on the server gives the
 * Google Identity Services flow the same disabled-user and staff routing
 * guarantees as the regular OAuth callback.
 */
