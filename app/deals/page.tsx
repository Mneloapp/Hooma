    ...
    <main className="bg-hooma-panel/60 pb-16">
      <section className="bg-hooma-text text-white">
        <div className="mx-auto max-w-[1480px] px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
          ...
          <h1 className="mt-4 max-w-4xl text-4xl font-semibold tracking-tight sm:text-5xl"><LocalizedText ka="დღის 100 განსხვავებული პროდუქტი −50%-ად" en="100 different products at 50% off today" /></h1>
