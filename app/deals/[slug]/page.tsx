  ...
  return (
    <main className="mx-auto max-w-[1280px] px-4 py-8 sm:px-6 lg:px-8">
      ...
      <section className="grid items-start gap-8 lg:grid-cols-[minmax(0,1fr)_minmax(0,0.8fr)_340px]">
        <div className="relative aspect-[4/3] overflow-hidden rounded-2xl bg-hooma-panel"><Image src={deal.image} alt={deal.name} fill priority className="object-cover" sizes="(min-width: 1024px) 45vw, 100vw" /><span className="absolute left-5 top-5 rounded-full bg-red-600 px-4 py-2 text-sm font-bold text-white">−{deal.discountPercent}%</span></div>
